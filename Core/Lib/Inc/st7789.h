...
void ST7789_PrintSymbol(uint16_t cStart, uint16_t rStart, uint8_t sb, uint16_t color, uint16_t bg_color, uint8_t font_size);
void ST7789_PrintStr(uint16_t cStart, uint16_t rStart, const char *str, uint8_t num, uint16_t color, uint16_t bg_color, uint8_t font_size);
void ST7789_PrintCustomStr(uint16_t cStart, uint16_t rStart, uint8_t *str, uint8_t buffer, uint8_t pos,
						   uint16_t color, uint16_t pos_color, uint16_t bg_color, uint8_t font_size);
void ST7789_PrintNumber(uint16_t cStart, uint16_t rStart, uint16_t Number, uint16_t color, uint16_t bg_color, uint8_t font_size);
void ST7789_PrintStrFieldWidth(uint16_t cStart, uint16_t rStart, const char *str, uint8_t len,
							   int8_t WidthField, uint8_t Symbol, uint16_t color, uint16_t bg_color, uint8_t font_size);
